...
/* themes/custom/gavias_daudo/templates/fields/field--field-portfolio-images--teaser-4.html.twig */
class __TwigTemplate_8b8bf8631820797e741666df3f1368ee extends Template
{
...
";
    ...
    ";
                ...
                // line 11
                yield "      <a href=\"";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (($__internal_compile_2 = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 11)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess && in_array($__internal_compile_2::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($__internal_compile_2["#item"] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 11), "#item", [], "array", false, false, true, 11)), "entity", [], "any", false, false, true, 11), "uri", [], "any", false, false, true, 11), "value", [], "any", false, false, true, 11), 11, $this->source)), "html", null, true);
                yield "\" class=\"image-popup d-none\" title=\"";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, (($__internal_compile_3 = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 11)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess && in_array($__internal_compile_3::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($__internal_compile_3["#item"] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 11), "#item", [], "array", false, false, true, 11)), "title", [], "any", false, false, true, 11), 11, $this->source), "html", null, true);
                yield "\"></a>
    ";
            }
        }
    ...
    {
        return "themes/custom/gavias_daudo/templates/fields/field--field-portfolio-images--teaser-4.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/gavias_daudo/templates/fields/field--field-portfolio-images--teaser-4.html.twig", "C:\\laragon\\www\\subic-gov\\themes\\custom\\gavias_daudo\\templates\\fields\\field--field-portfolio-images--teaser-4.html.twig");
    }
