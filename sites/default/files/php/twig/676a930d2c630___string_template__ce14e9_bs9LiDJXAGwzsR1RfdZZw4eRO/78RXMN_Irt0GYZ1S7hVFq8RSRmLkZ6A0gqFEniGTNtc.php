...
class __TwigTemplate_e91085543a8d5bb950cb249baa81d483 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        yield "</a>) <div>";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["core_compatibility_message"] ?? null), 1, $this->source), "html", null, true);
        yield "</div>";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["release_version", "release_link", "project_title", "release_notes", "core_compatibility_message"]);        yield from [];
    }
