...
if(!class_exists('element_gva_accordion')):
   class element_gva_accordion{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $number_active = (int)$number_active;
         ob_start();
         ?>
                     ...
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <h4 class="panel-title">
                             <a role="button" data-toggle="collapse" class="<?php print ($i == $number_active) ? '' : 'collapsed' ?>" href="#<?php print ($_id . '-' . $i) ?>">
                               <?php print $$title ?>
                             </a>
                           </h4>
                        </div>
                        <div id="<?php print ($_id . '-' . $i) ?>" class="panel-collapse collapse<?php if($i==$number_active) print ' in show' ?>" data-parent="#<?php print $_id; ?>">
