...
if(!class_exists('element_gva_image')):
   class element_gva_image{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         $margin_css = '';
         if( $margin ){
            $margin_css = 'style="margin-top:'.  $margin .'px"';
         } 
         ...
         ob_start();
         ?>
            <div class="widget gsc-image<?php if(count($class_array) > 0) print (' ' . implode(' ', $class_array)) ?>" <?php print $margin_css ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="widget-content">
                  <?php 
                     ...
                     if($link){ print '</a>'; }
                     if($caption){ 
                        echo '<div class="small image-caption margin-top-10">' . $caption . '</div>'; 
                     }
                  ?>
               </div>
            </div>    
